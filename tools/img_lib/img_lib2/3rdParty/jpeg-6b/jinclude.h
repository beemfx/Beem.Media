...
*/
#define JFREAD(readfunc, file,buf,sizeofbuf)  \
  ((size_t) readfunc((void *) (buf), (size_t) 1, (size_t) (sizeofbuf), (file)))

#define JFWRITE(file,buf,sizeofbuf)  \
  ((size_t) fwrite((const void *) (buf), (size_t) 1, (size_t) (sizeofbuf), (file)))
  
 typedef struct _JPG_CALLBACKS{
...
}JPG_CALLBACKS, *PJPG_CALLBACKS;

#endif __JINCLUDE_H__