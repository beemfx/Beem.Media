...
SUB render3d
	...
	IF dda = true THEN drawwall (20)
	IF ddb = true THEN drawwall (14)
	IF ddc = true THEN drawwall (13)
	IF ddd = true THEN drawwall (15)
	IF dde = true THEN drawwall (21)
	...
	IF ddh = true THEN drawwall (10)
	IF ddk = true THEN drawwall (22)
	IF ddo = true THEN drawwall (23)
	IF ddl = true THEN
	drawwall (4)
	drawwall (6)
	END IF
	...
	drawwall (5)
	END IF
	IF ddm = true THEN drawwall (3)
	IF ddp = true THEN drawwall (1)
	IF ddq = true THEN drawwall (2)
END SUB
